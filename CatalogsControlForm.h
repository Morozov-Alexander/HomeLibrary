...
namespace HomeLibrary {
	...
	/// <summary>
	/// Сводка для CatalogsControlForm
	/// </summary>
	...
	private: System::Windows::Forms::CheckedListBox^ Каталог_1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Каталог_1 = (gcnew System::Windows::Forms::CheckedListBox());
			this->SuspendLayout();
			// 
			// button1
			// 
			...
			this->button1->Text = L"удалить каталог";
			...
			this->button2->Text = L"редактировать каталог";
			...
			this->button3->Text = L"создать каталог";
			...
			this->button4->Text = L"просмотреть каталог";
			...
			this->button5->Text = L"добавить приватность";
			...
			this->button6->Text = L"удалить приватность";
			...
			this->button7->Text = L"изменить приватность";
			this->button7->UseVisualStyleBackColor = true;
			// 
			// Каталог_1
			// 
			this->Каталог_1->FormattingEnabled = true;
			this->Каталог_1->Location = System::Drawing::Point(502, 106);
			this->Каталог_1->Name = L"Каталог_1";
			this->Каталог_1->Size = System::Drawing::Size(315, 234);
			this->Каталог_1->TabIndex = 7;
			this->Каталог_1->SelectedIndexChanged += gcnew System::EventHandler(this, &CatalogsControlForm::checkedListBox1_SelectedIndexChanged);
			// 
			// CatalogsControlForm
			// 
			...
			this->Controls->Add(this->Каталог_1);
